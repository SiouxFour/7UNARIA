...
local mainItem = 130 -- 화폐로 사용할 데이터베이스 ID를 넣어주세요. 예) 데이터베이스의 3번인 보석을 화폐로 하고싶으면 3을 적습니다.
local shopName = "루비샵" -- 상점이름을 정해주세요.
-- 아이템 리스트
...
list_shop_1.name[1] = "" 
list_shop_1.adIt[1] = 603
list_shop_1.adCo[1] = 1
list_shop_1.neIt[1] = mainItem
list_shop_1.neCo[1] = 500

list_shop_1.name[2] = "" 
list_shop_1.adIt[2] = 140
list_shop_1.adCo[2] = 1
list_shop_1.neIt[2] = mainItem
list_shop_1.neCo[2] = 450

list_shop_1.name[3] = "" 
list_shop_1.adIt[3] = 609
list_shop_1.adCo[3] = 1
list_shop_1.neIt[3] = mainItem
list_shop_1.neCo[3] = 850

list_shop_1.name[4] = "" 
list_shop_1.adIt[4] = 613
list_shop_1.adCo[4] = 1
list_shop_1.neIt[4] = mainItem
list_shop_1.neCo[4] = 1600

list_shop_1.name[5] = "" 
list_shop_1.adIt[5] = 612
list_shop_1.adCo[5] = 1
list_shop_1.neIt[5] = mainItem
list_shop_1.neCo[5] = 3000

list_shop_1.name[6] = "" 
list_shop_1.adIt[6] = 623
list_shop_1.adCo[6] = 1
list_shop_1.neIt[6] = mainItem
list_shop_1.neCo[6] = 1050

list_shop_1.name[7] = "" 
list_shop_1.adIt[7] = 630
list_shop_1.adCo[7] = 1
list_shop_1.neIt[7] = mainItem
list_shop_1.neCo[7] = 1290

list_shop_1.name[8] = "" 
list_shop_1.adIt[8] = 177
list_shop_1.adCo[8] = 1
list_shop_1.neIt[8] = mainItem
list_shop_1.neCo[8] = 2990

list_shop_1.name[9] = "" 
list_shop_1.adIt[9] = 634
list_shop_1.adCo[9] = 1
list_shop_1.neIt[9] = mainItem
list_shop_1.neCo[9] = 2590

-------------------------------------------------------
panel_shop = Panel()
panel_shop.rect = Rect(0, 0, Client.width, Client.height)
panel_shop.color = Color(0, 0, 25, 200)
...
function Item_List(var)
	...
	for i=1, #list_shop.name do
		...
		list_shop.btn[i].color = Color(0, 0, 0, 255)
...
panel_shop_info.color = Color(0, 0, 0, 200)
