...
ttype = {"", "", "", "", ""}
statName = {" 공격력"," 방어력"," 마법공격력"," 마법방어력"," 치명타데미지"," 치명타확률"," HP"," MP"}
...
function c_market:list()
	...
	button[2] = Button("내장터",Rect(5,5,90,40))
...
function c_market:setPrice(Titem_count)
	...
	i00.pivotY = 0.5
	i00.textAlign = 3
	i00.placeholder = "가격을 입력해주세요(낱개가격X)"
	mask.AddChild(i00)
	...
	i01.pivotY = 0.5
	i01.textAlign = 3
	i01.placeholder = "수량을 입력해주세요 " .. "보유수량(" .. Titem_count .. "개)"
	mask.AddChild(i01)
