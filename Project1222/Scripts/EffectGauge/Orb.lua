...
lv_x_pos = 250            --기본 250
lv_y_pos = 335            --기본 335
lv_text_size = 25         --기본 25


--체력 텍스트 위치 및 크기 설정
hp_text_x_pos = 330       --기본 330
hp_text_y_pos = 375       --기본 375
hp_text_size = 15         --기본 15


--마력 텍스트 위치 및 크기 설정
mp_text_x_pos = 330       --기본 330
mp_text_y_pos = 405       --기본 405
mp_text_size = 15         --기본 15
...
--게이지 위치 설정
gauge_hp_x_pos = 240      --체력 게이지의 가로 위치 기본240
gauge_hp_y_pos = 375      --체력 게이지의 세로 위치 기본375

gauge_mp_x_pos = 240      --마력 게이지의 가로 위치 기본240
gauge_mp_y_pos = 405      --마력 게이지의 세로 위치 기본405
...
--게이지 크기 설정
gauge_hp_x_size = 260      --체력 게이지의 가로 길이 기본260
gauge_hp_y_size = 25       --체력 게이지의 세로 길이 기본25

gauge_mp_x_size = 260      --마력 게이지의 가로 길이 기본260
gauge_mp_y_size = 25       --마력 게이지의 세로 길이 기본25

gauge_xp_x_size = Client.width      --경험치 게이지의 가로 길이
gauge_xp_y_size = 10       --경험치 게이지의 세로 길이 기본10
